...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, load_initial_expertdata, collect_policy, batch_size):
        ...
        """
        #sample_trajectory(self.env, collect_policy, self.params['ep_len'], render=False, render_mode=('rgb_array')):
        #sample_n_trajectories(self.env, collect_policy, batch_size, self.params['ep_len'], render=False, render_mode=('rgb_array')):
        
        if itr == 0:
            paths = load_initial_expertdata
            envsteps_this_batch = 0
        else:
            paths, envsteps_this_batch = sample_trajectories(self.env, collect_policy, batch_size, self.params['ep_len'], render=False, render_mode=('rgb_array'))
        ...
        paths, envsteps_this_batch = paths, envsteps_this_batch

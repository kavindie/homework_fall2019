...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        sample_indices  = np.random.permutation(batch_size)
        obs_random = list(self.obs[i] for i in sample_indices)
        acs_random = list(self.acs[i] for i in sample_indices)
        rews_random = list(self.rews[i] for i in sample_indices)
        next_obs_random = list(self.next_obs[i] for i in sample_indices)
        terminals_random = list(self.terminalss[i] for i in sample_indices)
        ...
        return obs_random, acs_random, rews_random, next_obs_random, terminals_random
